    ...
    <div className="blog_single_container">
      <div className="blog_single_inner">
        <div className="blog_single_content">
          <img src={sampleBlog.image} alt={sampleBlog.title} />
          <div className="blog_author">
            <img
              className="blog_author_image"
              src={sampleBlog.authorImage}
              alt={sampleBlog.author}
            />
            <div className="blog_info">
              <span className="blog_author_name">{sampleBlog.author}</span>
              <br />
              <span className="blog_date_posted">Posted {sampleBlog.date}</span>
            </div>
            <div className="edit_blog">
              <Link to={`/blog/write?edit=${sampleBlog.id}`}>
          ...
          <h1 className="blog_single_title">{sampleBlog.title}</h1>
          {/* TODO Add error handling if something is wrong with text */}
          <div className="blog_single_text">{sampleBlog.text}</div>
        </div>
